...
creator.use(bodyParser.urlencoded({ extended: true }));
creator.use(express.json());
creator.use(express.static('public'));
...
- Render home view 
-------------------------*/
creator.route("/videos").get(async (req, res) => {
  try {
